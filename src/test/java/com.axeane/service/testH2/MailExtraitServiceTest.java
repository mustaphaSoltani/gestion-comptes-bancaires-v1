...
//    }
    ...
    @Test
    public void testSendv3() throws MailjetException, MalformedURLException, UnsupportedEncodingException, MailjetSocketTimeoutException, JSONException {
        MailjetClient client;
        client = new MailjetClient("", "");
        client.setDebug(MailjetClient.NOCALL_DEBUG);
    ...
    @Test
    public void testSendv31() throws MailjetException, MalformedURLException, UnsupportedEncodingException, MailjetSocketTimeoutException, JSONException {
        MailjetClient client;
